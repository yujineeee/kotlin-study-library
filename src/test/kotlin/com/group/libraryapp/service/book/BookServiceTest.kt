...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest() {
        ...
        assertThat(results[0].status).isEqualTo(UserLoanStatus.LOANDED)
    }
    ...
    fun returnBookTest() {
        ...
        val results = userLoanHistoryRepository.findAll()
        assertThat(results).hasSize(1)
        assertThat(results[0].status).isEqualTo(UserLoanStatus.RETURNRED)
    }
    ...
    fun countLoanedBookTest() {
        //given
        val savedUser = userRepository.save(User("김씨", null))
        userLoanHistoryRepository.saveAll(listOf(
            UserLoanHistory.fixture(savedUser, "A"),
            UserLoanHistory.fixture(savedUser, "B", UserLoanStatus.RETURNRED),
            UserLoanHistory.fixture(savedUser, "C", UserLoanStatus.RETURNRED),
        ))
